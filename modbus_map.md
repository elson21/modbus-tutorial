| Category | Data Point | Offset | Type | Unit
|----------|------------|--------|------|------|
| **String** | String DC Voltage | +0 | Input Reg | $0.1$ V |
| **String** | String DC Current | +1 | Input Reg | $0.1$ A |
| **Pack 1** | Pack Voltage | +100 | Input Reg | $0.1$ V |
| **Pack 2** | Pack Voltage | +200 | Input Reg | $0.1$ V |
